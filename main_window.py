...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy2.setHeightForWidth(self.Lb_userInput.sizePolicy().hasHeightForWidth())
        self.Lb_userInput.setSizePolicy(sizePolicy2)
        font1 = QFont()
        ...
        sizePolicy3.setHeightForWidth(self.LnEd_baseInput.sizePolicy().hasHeightForWidth())
        self.LnEd_baseInput.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.PshBtn_printText.sizePolicy().hasHeightForWidth())
        self.PshBtn_printText.setSizePolicy(sizePolicy3)
